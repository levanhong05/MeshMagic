...
=========================================================================*/
// .NAME vtkOverlappingAMR2 - hierarchical dataset of vtkUniformGrids
//
// .SECTION Description
// vtkOverlappingAMR2 extends vtkUniformGridAMR by exposing access to the
...
class VTK_EXPORT vtkOverlappingAMR2: public vtkUniformGridAMR2
{
public:
  static vtkOverlappingAMR2 *New();

  // Description:
  // Return class name of data type (see vtkType.h for definitions).
  virtual int GetDataObjectType() {return VTK_OVERLAPPING_AMR;}

  vtkTypeMacro(vtkOverlappingAMR2,vtkUniformGridAMR2);
  ...
  static vtkOverlappingAMR2* GetData(vtkInformation* info)
    { return vtkOverlappingAMR2::SafeDownCast(Superclass::GetData(info)); }
  static vtkOverlappingAMR2* GetData(vtkInformationVector* v, int i=0)
    { return vtkOverlappingAMR2::SafeDownCast(Superclass::GetData(v, i)); }
  //ETX
 ...
 protected:
  vtkOverlappingAMR2();
  virtual ~vtkOverlappingAMR2();

private:
  vtkOverlappingAMR2(const vtkOverlappingAMR2&);  // Not implemented.
  void operator=(const vtkOverlappingAMR2&);  // Not implemented.
};
