...
msbuild /m /p:TreatWarningsAsErrors=false;Configuration=Debug ALL_BUILD.vcxproj

msbuild /m /p:TreatWarningsAsErrors=false;Configuration=Debug INSTALL.vcxproj
