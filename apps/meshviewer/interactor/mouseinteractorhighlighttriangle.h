...
** File:      MouseInteractorHighLightTriangle.h
**
...
#ifndef MOUSEINTERACTORHIGHLIGHTTRIANGLE_H
#define MOUSEINTERACTORHIGHLIGHTTRIANGLE_H
...
// Catch mouse events
class MouseInteractorHighLightTriangle : public vtkInteractorStyleTrackballCamera
{
public:
    static MouseInteractorHighLightTriangle *New();
    vtkTypeMacro(MouseInteractorHighLightTriangle, vtkInteractorStyleTrackballCamera);

    MouseInteractorHighLightTriangle()
    {
    ...
    MouseInteractorHighLightTriangle::~MouseInteractorHighLightTriangle()
    {
...
#endif // MOUSEINTERACTORHIGHLIGHTTRIANGLE_H
